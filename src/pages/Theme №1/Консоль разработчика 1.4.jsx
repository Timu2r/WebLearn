	...
	return (
		<Container className='text-light mt-5'>
			...
			<p>
				...
				отладку кода в главе Отладка в браузере.
			</p>
			...
			<p>
				...
				на <span className='text-danger'>F12</span>.
			</p>
			<p>
			...
			<p>
				Откройте Настройки (Preferences) и перейдите к панели «Продвинутые»
				(Advanced). В самом низу вы найдёте чекбокс:
			</p>
			...
			<p style={{ marginTop: '30px' }}>
				...
				<span className='text-danger'>Cmd+Opt+C</span> . Также обратите внимание
				на новый элемент меню «Разработка» («Develop»). В нем содержится большое
				количество команд и настроек.
			</p>
			<h1
				style={{
					fontSize: '1.7rem',
			...
			<ul>
				...
				<li>
					...
					разработчика можно открыть, нажав{' '}
					<span className='text-danger'>F12</span>. В Chrome для Mac используйте
					комбинацию <span className='text-danger'>Cmd+Opt+J</span> , Safari:{' '}
					<span className='text-danger'>Cmd+Opt+C</span> (необходимо
					предварительное включение «Меню разработчика»).
				</li>
			</ul>
			<p>
