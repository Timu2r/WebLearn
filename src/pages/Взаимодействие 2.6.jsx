  ...
  alert(\`Тебе звать \${name}!\`); // Тебя зовут Илона!`}
			...
			>
				...
				<p>
					...
					Internet Explorer вставит строку U+0022undefinedU+0022 в поле для ввода.
				</p>
				...
				<CodeJs
					js={` let test = prompt("Test", ''); // <-- для IE`}
				/>
			</div>
			<h1>confirm</h1>
  ...
  alert( isBoss ); // true, если нажата OK`}
			...
			<p>показывает сообщение.</p>
				<Badge bg='secondary'>prompt</Badge>
					<p>показывает сообщение и запрашивает ввод текста от пользователя. Возвращает напечатанный в поле ввода текст или <Badge bg='secondary'>null</Badge>, если была нажата кнопка «Отмена» или <Badge bg='success'>Esc</Badge> с клавиатуры.</p>
				<Badge bg='secondary'>confirm</Badge>
					<p>показывает сообщение и ждёт, пока пользователь нажмёт OK или Отмена. Возвращает <Badge bg='secondary'>true</Badge>, если нажата OK, и <Badge bg='secondary'>false</Badge>, если нажата кнопка «Отмена» или <Badge bg='success'>Esc</Badge> с клавиатуры.</p>
