...
while (i < 3) { // выводит 0, затем 1, затем 2
  ...
  i++;
      ...
      <p>
        ...
        **итерация**. Цикл в примере выше совершает три итерации.
      </p>
      <p>
...
do {
  ...
  alert(i);
      ...
      {/* Переделанная таблица с использованием компонента Table из react-bootstrap */}
      <div
        className='table-responsive' // Добавляем класс для адаптивности
        style={{
          border: '2px solid rgb(108, 117, 125)',
          borderRadius: '8px',
          margin: '20px 0',
          padding: '0', // Убираем padding здесь, чтобы таблица растягивалась
      ...
      >
        <Table
          ...
          bordered
          hover
          variant='dark' // Применяет тёмный вариант таблицы
          className='mb-0' // Убираем нижний отступ, так как padding уже есть вокруг
          style={{ width: '100%' }} // Таблица занимает всю доступную ширину
        >
          <thead>
            <tr>
              <th style={{ padding: '10px', textAlign: 'left' }}>Часть</th>
              <th style={{ padding: '10px', textAlign: 'left' }}>Пример</th>
...
alert('Готово!');`}
      ...
      {/* Исправленная последняя таблица */}
      <div
        className='table-responsive' // Добавляем класс для адаптивности
        style={{
          border: '2px solid rgb(108, 117, 125)',
      ...
      >
        <h3>Основные циклы JavaScript</h3> {/* Заголовок для таблицы */}
        <Table
          striped
          bordered
          hover
        ...
        >
          <thead>
            <tr>
              <th style={{ padding: '10px', textAlign: 'left' }}>Цикл</th>
              <th style={{ padding: '10px', textAlign: 'left' }}>Когда использовать</th>
              <th style={{ padding: '10px', textAlign: 'left' }}>Особенности</th>
            </tr>
          </thead>
          <tbody>
            <tr>
