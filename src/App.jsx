...
import Objects from './pages/Theme №4/Objects 4.1.jsx'
import ObjectReferences from './pages/Theme №4/ObjectReferences 4.2.jsx';
import GarbageCollection from './pages/Theme №4/ObjectReferences 4.3.jsx';
import ObjectMethods from './pages/Theme №4/ObjectMethods 4.4.jsx';
import ConstructorNew from './pages/Theme №4/ConstructorNew 4.5.jsx';
  ...
  return (
    <Router basename="/WebLearn">
      ...
      {/* Theme #3 */}
        ...
        <Route path="/ObjectReferences" element={<ObjectReferences />} />
        <Route path="/GarbageCollection" element={<GarbageCollection />} />
        <Route path="/ObjectMethods" element={<ObjectMethods />} />
        <Route path="/ConstructorNew" element={<ConstructorNew />} />
      </Routes>
      <Footer />
    </Router>
  );
