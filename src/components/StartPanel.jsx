	...
	const courses = [
		{
			...
			icon: <RiJavascriptFill className='course-icon js-icon' size={45} />,
		...
		},
		{
			...
			icon: <SiCss3 className='course-icon css-icon' size={40} />,
			color: 'css-gradient',
			lessons: [
		...
		},
		{
			...
			icon: <SiHtml5 className='course-icon html-icon' size={40} />,
			color: 'html-gradient',
			lessons: [
				{ name: 'Hello World', path: '/HelloWorld' },
				{ name: 'Структура кода', path: '/StructureCode' },
					...
					{courses.map((course, index) => (
						<div key={index} className='course-block'>
							<div className='course-header'>
								...
								<div>
									<h3 className={`course-title ${course.color}`}>
										{course.title}
									</h3>
							...
							<div className='lessons-grid'>
								{course.lessons.map((lesson, lessonIndex) => (
									<button
										...
										className={`lesson-button ${course.color}`}
									>
