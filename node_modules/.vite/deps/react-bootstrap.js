...
var useCommittedRef_default2 = useCommittedRef;
...
var alignDirection = import_prop_types3.default.oneOf(["start", "end"]);
var alignPropType = import_prop_types3.default.oneOfType([alignDirection, import_prop_types3.default.shape({
  sm: alignDirection
...
var FormLabel = React77.forwardRef(({
  ...
  htmlFor = htmlFor || controlId;
  if (column) return (0, import_jsx_runtime68.jsx)(Col_default, {
    ref,
    as: "label",
    className: classes,
    htmlFor,
...
var Switch = React81.forwardRef((props, ref) => (0, import_jsx_runtime72.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var Modal = (0, import_react70.forwardRef)((_ref, ref) => {
  ...
  return (0, import_jsx_runtime84.jsx)(import_jsx_runtime84.Fragment, {
    children: import_react_dom3.default.createPortal((0, import_jsx_runtime84.jsxs)(import_jsx_runtime84.Fragment, {
...
var Modal2 = React99.forwardRef(({
  ...
  const [modalStyle, setStyle] = (0, import_react71.useState)({});
  const [animateStaticModal, setAnimateStaticModal] = (0, import_react71.useState)(false);
  const waitingForMouseUpRef = (0, import_react71.useRef)(false);
  const ignoreBackdropClickRef = (0, import_react71.useRef)(false);
  const removeStaticModalAnimationRef = (0, import_react71.useRef)(null);
  ...
  const renderBackdrop = (0, import_react71.useCallback)((backdropProps) => (0, import_jsx_runtime90.jsx)("div", {
    ...backdropProps,
  ...
  const renderDialog = (dialogProps) => (0, import_jsx_runtime90.jsx)("div", {
    ...
    "aria-labelledby": ariaLabelledby,
    "aria-describedby": ariaDescribedby,
    children: (0, import_jsx_runtime90.jsx)(Dialog, {
      ...props,
  ...
  return (0, import_jsx_runtime90.jsx)(ModalContext_default.Provider, {
    value: modalContext,
...
var Nav2 = React102.forwardRef((uncontrolledProps, ref) => {
  ...
  let isNavbar = false;
  const navbarContext = (0, import_react72.useContext)(NavbarContext_default);
  const cardHeaderContext = (0, import_react72.useContext)(CardHeaderContext_default);
  if (navbarContext) {
  ...
  return (0, import_jsx_runtime93.jsx)(Nav_default, {
    as,
    ref,
    activeKey,
...
var NavbarCollapse = React104.forwardRef(({
  ...
  return (0, import_jsx_runtime95.jsx)(Collapse_default, {
...
var NavbarToggle = React105.forwardRef(({
  ...
  const {
    onToggle,
    expanded
  } = (0, import_react74.useContext)(NavbarContext_default) || {};
  ...
  return (0, import_jsx_runtime96.jsx)(Component2, {
    ...
    children: children || (0, import_jsx_runtime96.jsx)("span", {
...
function useMediaQuery(query, targetWindow = typeof window === "undefined" ? void 0 : window) {
  ...
  const [matches, setMatches] = (0, import_react75.useState)(() => mql ? mql.matches : false);
  useIsomorphicEffect_default2(() => {
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    let query = (0, import_react76.useMemo)(() => Object.entries(breakpointMap).reduce((query2, [key, direction2]) => {
...
var OffcanvasToggling = React107.forwardRef(({
  ...
  return (0, import_jsx_runtime98.jsx)(TransitionWrapper_default, {
    ref,
    addEndListener: transitionEndListener,
    in: inProp,
    mountOnEnter,
...
var OffcanvasHeader = React108.forwardRef(({
  ...
  return (0, import_jsx_runtime99.jsx)(AbstractModalHeader_default, {
    ref,
    ...props,
...
function DialogTransition2(props) {
  return (0, import_jsx_runtime101.jsx)(OffcanvasToggling_default, {
    ...props
  });
}
function BackdropTransition2(props) {
  return (0, import_jsx_runtime101.jsx)(Fade_default, {
    ...props
  });
}
var Offcanvas = React110.forwardRef(({
  ...
  const modalManager = (0, import_react77.useRef)();
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
  const [showOffcanvas, setShowOffcanvas] = (0, import_react77.useState)(false);
  const handleHide = useEventCallback(onHide);
  ...
  const renderBackdrop = (0, import_react77.useCallback)((backdropProps) => (0, import_jsx_runtime101.jsx)("div", {
    ...backdropProps,
    className: (0, import_classnames77.default)(`${bsPrefix}-backdrop`, backdropClassName)
  }), [backdropClassName, bsPrefix]);
  const renderDialog = (dialogProps) => (0, import_jsx_runtime101.jsx)("div", {
    ...dialogProps,
    ...props,
  ...
  return (0, import_jsx_runtime103.jsxs)(import_jsx_runtime102.Fragment, {
    children: [!showOffcanvas && (responsive || renderStaticNode) && renderDialog({}), (0, import_jsx_runtime101.jsx)(ModalContext_default.Provider, {
      value: modalContext,
      children: (0, import_jsx_runtime101.jsx)(Modal_default, {
        show: showOffcanvas,
        ref,
        backdrop,
        container,
...
var NavbarOffcanvas = React111.forwardRef(({
  onHide,
  ...props
}, ref) => {
  const context6 = (0, import_react78.useContext)(NavbarContext_default);
  const handleHide = useEventCallback(() => {
    context6 == null || context6.onToggle == null || context6.onToggle();
    onHide == null || onHide();
  });
  return (0, import_jsx_runtime104.jsx)(Offcanvas_default, {
    ref,
...
var Navbar = React113.forwardRef((props, ref) => {
  ...
  const handleCollapse = (0, import_react79.useCallback)((...args) => {
  ...
  const navbarContext = (0, import_react79.useMemo)(() => ({
    onToggle: () => onToggle == null ? void 0 : onToggle(!expanded),
    bsPrefix,
    expanded: !!expanded,
    expand
  }), [bsPrefix, expanded, expand, onToggle]);
  return (0, import_jsx_runtime106.jsx)(NavbarContext_default.Provider, {
    value: navbarContext,
...
var NavDropdown = React114.forwardRef(({
  ...
  return (0, import_jsx_runtime108.jsxs)(Dropdown_default2, {
    ref,
    ...props,
    className: (0, import_classnames80.default)(className, navItemPrefix),
    children: [(0, import_jsx_runtime107.jsx)(Dropdown_default2.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
      ...
      as: NavLink_default,
      children: title
    }), (0, import_jsx_runtime107.jsx)(Dropdown_default2.Menu, {
      role: menuRole,
      renderOnMount: renderMenuOnMount,
      rootCloseEvent,
      variant: menuVariant,
...
var Overlay = React115.forwardRef((props, outerRef) => {
  ...
  const [exited, setExited] = (0, import_react81.useState)(!props.show);
...
var Popover = React119.forwardRef(({
  ...
  return (0, import_jsx_runtime112.jsxs)("div", {
    ...
    children: [(0, import_jsx_runtime111.jsx)("div", {
      ...
      ...arrowProps
    }), body ? (0, import_jsx_runtime111.jsx)(PopoverBody_default, {
      children
    }) : children]
  });
});
...
function useOverlayOffset(customOffset) {
  ...
  const offset2 = (0, import_react82.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
        if (customOffset) {
...
var Overlay2 = React121.forwardRef(({
  ...
  const popperRef = (0, import_react83.useRef)({});
  const [firstRenderedState, setFirstRenderedState] = (0, import_react83.useState)(null);
  ...
  return (0, import_jsx_runtime115.jsx)(Overlay_default, {
    ...outerProps,
    ref: mergedRef,
    popperConfig: {
      ...popperConfig,
...
var OverlayTrigger = ({
  ...
  const handleShow = (0, import_react84.useCallback)(() => {
    timeout2.clear();
  ...
  const handleHide = (0, import_react84.useCallback)(() => {
    timeout2.clear();
  ...
  const handleFocus = (0, import_react84.useCallback)((...args) => {
    handleShow();
    onFocus == null || onFocus(...args);
  }, [handleShow, onFocus]);
  const handleBlur = (0, import_react84.useCallback)((...args) => {
    handleHide();
    onBlur == null || onBlur(...args);
  }, [handleHide, onBlur]);
  const handleClick = (0, import_react84.useCallback)((...args) => {
    setShow(!show);
    onClick == null || onClick(...args);
  }, [onClick, setShow, show]);
  const handleMouseOver = (0, import_react84.useCallback)((...args) => {
    handleMouseOverOut(handleShow, args, "fromElement");
  }, [handleShow]);
  const handleMouseOut = (0, import_react84.useCallback)((...args) => {
  ...
  return (0, import_jsx_runtime118.jsxs)(import_jsx_runtime117.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react84.cloneElement)(children, triggerProps), (0, import_jsx_runtime116.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var PageItem = React123.forwardRef(({
  ...
  return (0, import_jsx_runtime119.jsx)("li", {
    ref,
    style: style2,
    ...
    children: (0, import_jsx_runtime120.jsxs)(Component2, {
      className: (0, import_classnames86.default)("page-link", linkClassName),
      style: linkStyle,
      ...props,
      children: [children, active && activeLabel && (0, import_jsx_runtime119.jsx)("span", {
        className: "visually-hidden",
...
function createButton(name, defaultValue, label = name) {
  const Button3 = React123.forwardRef(({
    children,
    ...props
  }, ref) => (0, import_jsx_runtime120.jsxs)(PageItem, {
    ...props,
    ref,
    children: [(0, import_jsx_runtime119.jsx)("span", {
      "aria-hidden": "true",
      children: children || defaultValue
    }), (0, import_jsx_runtime119.jsx)("span", {
      className: "visually-hidden",
      children: label
    })]
  }));
...
var Pagination = React124.forwardRef(({
  ...
  return (0, import_jsx_runtime121.jsx)("ul", {
    ref,
    ...props,
...
var PlaceholderButton = React125.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime122.jsx)(Button_default2, {
    ...placeholderProps,
    ref,
    disabled: true,
    tabIndex: -1
...
function renderProgressBar({
  ...
  return (0, import_jsx_runtime124.jsx)("div", {
    ...
    "aria-valuemin": min2,
    "aria-valuemax": max2,
    children: visuallyHidden ? (0, import_jsx_runtime124.jsx)("span", {
      className: "visually-hidden",
      children: label
    }) : label
  });
...
var ProgressBar = React127.forwardRef(({
  ...
  return (0, import_jsx_runtime124.jsx)("div", {
    ...
    children: children ? map(children, (child) => (0, import_react85.cloneElement)(child, {
      isChild: true
    })) : renderProgressBar({
      min: min2,
      now,
...
var Spinner = React130.forwardRef(({
  bsPrefix,
  variant,
  animation = "border",
  size: size2,
...
var SplitButton = React131.forwardRef(({
  id,
  bsPrefix,
  size: size2,
  variant,
  ...
  flip: flip2,
  ...props
}, ref) => (0, import_jsx_runtime129.jsxs)(Dropdown_default2, {
  ref,
  ...props,
  as: ButtonGroup_default,
  children: [(0, import_jsx_runtime128.jsx)(Button_default2, {
    size: size2,
    variant,
    ...
    type,
    children: title
  }), (0, import_jsx_runtime128.jsx)(Dropdown_default2.Toggle, {
    split: true,
    id,
    size: size2,
    variant,
  ...
  }), (0, import_jsx_runtime128.jsx)(Dropdown_default2.Menu, {
    role: menuRole,
    renderOnMount: renderMenuOnMount,
    rootCloseEvent,
    flip: flip2,
...
function useTabPanel(_ref) {
  ...
  const context6 = (0, import_react86.useContext)(TabContext_default);
...
var TabPanel = React133.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  (_ref2, ref) => {
    let {
      as: Component2 = "div"
    ...
    return (0, import_jsx_runtime131.jsx)(TabContext_default.Provider, {
      value: null,
      children: (0, import_jsx_runtime131.jsx)(SelectableContext_default.Provider, {
        value: null,
        children: (0, import_jsx_runtime131.jsx)(Transition2, {
          in: isActive,
          onEnter,
          onEntering,
          onEntered,
          ...
          mountOnEnter,
          unmountOnExit,
          children: (0, import_jsx_runtime131.jsx)(Component2, Object.assign({}, tabPanelProps, {
            ref,
            hidden: !isActive,
...
var Tabs = (props) => {
  ...
  const generateChildId = (0, import_react87.useMemo)(() => generateCustomChildId || ((key, type) => id ? `${id}-${type}-${key}` : null), [id, generateCustomChildId]);
  const tabContext = (0, import_react87.useMemo)(() => ({
    onSelect,
    activeKey,
    transition,
...
var TabContainer = ({
  transition,
  ...props
}) => (0, import_jsx_runtime133.jsx)(Tabs_default, {
  ...props,
  ...
  return (0, import_jsx_runtime135.jsx)(TabContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime135.jsx)(SelectableContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime135.jsx)(Transition2, {
        ...
        mountOnEnter,
        unmountOnExit,
        children: (0, import_jsx_runtime135.jsx)(Component2, {
          ...rest,
          ref,
...
var Table = React137.forwardRef(({
  ...
  const table = (0, import_jsx_runtime136.jsx)("table", {
    ...props,
    className: classes,
    ref
  });
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime137.jsx)(NavItem_default2, {
    as: "li",
    role: "presentation",
    children: (0, import_jsx_runtime137.jsx)(NavLink_default, {
      as: "button",
      type: "button",
      eventKey,
      disabled,
...
var Tabs2 = (props) => {
  ...
  return (0, import_jsx_runtime138.jsxs)(Tabs_default, {
    id,
    activeKey,
    onSelect,
    transition: getTabTransitionComponent(transition),
    mountOnEnter,
    unmountOnExit,
    children: [(0, import_jsx_runtime137.jsx)(Nav_default2, {
      id,
      ...controlledProps,
      role: "tablist",
      as: "ul",
    ...
    }), (0, import_jsx_runtime137.jsx)(TabContent_default, {
      children: map(children, (child) => {
        ...
        return (0, import_jsx_runtime137.jsx)(TabPane_default, {
          ...childProps
        });
      })
    })]
...
var ToastFade = React139.forwardRef((props, ref) => (0, import_jsx_runtime139.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastHeader = React141.forwardRef(({
  ...
  const context6 = (0, import_react88.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
    context6 == null || context6.onClose == null || context6.onClose(e);
  });
  return (0, import_jsx_runtime141.jsxs)("div", {
    ref,
    ...props,
    className: (0, import_classnames97.default)(bsPrefix, className),
    children: [children, closeButton && (0, import_jsx_runtime140.jsx)(CloseButton_default, {
      "aria-label": closeLabel,
      variant: closeVariant,
      onClick: handleClick,
      "data-dismiss": "toast"
...
var ToastBody = React142.forwardRef(({
  ...
  return (0, import_jsx_runtime142.jsx)(Component2, {
    ref,
...
var Toast = React143.forwardRef(({
  ...
  const delayRef = (0, import_react89.useRef)(delay);
  const onCloseRef = (0, import_react89.useRef)(onClose);
  ...
  const autohideFunc = (0, import_react89.useCallback)(() => {
    if (autohideToast) {
  ...
  const toastContext = (0, import_react89.useMemo)(() => ({
    onClose
  }), [onClose]);
  const hasAnimation = !!(Transition2 && animation);
  const toast = (0, import_jsx_runtime143.jsx)("div", {
    ...props,
    ref,
  ...
  return (0, import_jsx_runtime143.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition2 ? (0, import_jsx_runtime143.jsx)(Transition2, {
      in: show,
      onEnter,
      onEntering,
      onEntered,
...
var ToggleButton = React145.forwardRef(({
  ...
  return (0, import_jsx_runtime147.jsxs)(import_jsx_runtime146.Fragment, {
    children: [(0, import_jsx_runtime145.jsx)("input", {
      className: bsPrefix,
      name,
      type,
      value,
      ...
      id
    }), (0, import_jsx_runtime145.jsx)(Button_default2, {
      ...props,
      ref,
...
var ToggleButtonGroup = React146.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime148.jsx)(ButtonGroup_default, {
    ...controlledProps,
    ref,
    vertical,
    children: map(children, (child) => {
